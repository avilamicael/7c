...
const STATUS_COLOR = {
  ...
  PAGA:              "bg-emerald-100 text-emerald-700 border-emerald-200 dark:bg-emerald-950/40 dark:text-emerald-400 dark:border-emerald-900",
  VENCIDA:           "bg-red-100 text-red-700 border-red-200 dark:bg-red-950/40 dark:text-red-400 dark:border-red-900",
  PARCIALMENTE_PAGA: "bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-950/40 dark:text-blue-400 dark:border-blue-900",
  ...
  return (
    <div className="flex flex-col gap-6">
      <KPICards
        ...
        totalPagoOuRecebido={kpis.totalPagoNoMes}
        totalContas={kpis.totalContas}
        labelPagoOuRecebido="Total Pago no Mês"
      />
      ...
      <div className="flex flex-wrap items-end gap-3 rounded-lg border bg-card p-4">
        <div className="flex flex-1 flex-col gap-1.5 min-w-[200px]">
          ...
          <div className="relative">
            ...
            <Input placeholder="Fornecedor ou Nº documento..." value={search} onChange={(e) => setSearch(e.target.value)} className="pl-9" />
          </div>
        </div>
