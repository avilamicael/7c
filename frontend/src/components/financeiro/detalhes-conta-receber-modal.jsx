...
const STATUS_COLOR = {
  ...
  RECEBIDA:              "bg-emerald-100 text-emerald-700 border-emerald-200",
  VENCIDA:               "bg-red-100 text-red-700 border-red-200",
  PARCIALMENTE_RECEBIDA: "bg-blue-100 text-blue-700 border-blue-200",
...
export function DetalhesContaReceberModal({ conta, onClose }) {
  return (
          ...
          <ScrollArea className="max-h-[65vh] pr-4">
            <div className="flex flex-col gap-6">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <InfoField label="Cliente / Fonte" value={conta.cliente_nome ?? conta.fornecedor_nome} />
